...
export default function VisitorBadge() {
  ...
  return (
    <div className="fixed left-3 top-1/2 z-[70] -translate-y-1/2 rounded-2xl border border-white/10 bg-[#07101d]/80 px-3 py-2 text-xs text-white/70 backdrop-blur-xl">
